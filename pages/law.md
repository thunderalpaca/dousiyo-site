...
### 第一条（目的）
本法は、鉄道網の無秩序な拡大を防ぎ、サーバーリソースを保護するとともに、公共交通としての鉄道の役割を明確にすることを目的とする。

### 第二条（定義）
本法において「鉄道」とは、レール上を走行する**車両**、およびそれに関連する駅、線路、信号設備等のインフラ全般を指す。

### 第三条（運行会社の認可）
公共の輸送を目的として広範囲に鉄道を敷設し、運行しようとする個人または団体は、事前に運営チームに事業計画を提出し、「認可鉄道会社」としての認可を受けなければならない。

### 第四条（非認可会社の運行制限）
前条の認可を受けていない個人または団体（以下「非認可会社」）が鉄道を運行する場合、以下の制限を遵守しなければならない。
一. 保有できる編成（連結された車両のまとまり）は**3編成**までとする。
二. すべての編成の合計**車両数**は**6両**以下でなければならない。

### 第五条（燃料の搭載禁止）
**燃料を消費して自走する車両**に燃料を搭載し、自動で走行させる行為は、サーバーへの負荷を考慮し、認可鉄道会社であるか否かを問わず、これを**禁止**する。

### 第六条（罰則）
本法の規定に違反した者に対しては、警告、超過した車両や設備の撤去、または悪質な場合には鉄道運行の全面禁止およびその他の処分を行うことができる。
